...
public partial class CreateAirportVMValidator : AbstractValidator<CreateAirportVM>
{
    private readonly ICityService _cityService;
    private readonly IAirportService _airportService;

    public CreateAirportVMValidator(ICityService cityService, IAirportService airportService)
    {
        ...
        _ = RuleFor(x => x.ICAO)
                .MustAsync(async (icao, ct) =>
                {
                    ...
                    return !await _airportService.ExistsByICAOAsync(normalized, token: ct);
                })
        ...
        _ = RuleFor(x => x.IATA)
                .MustAsync(async (iata, ct) =>
                {
                    ...
                    return !await _airportService.ExistsByIATAAsync(normalized, token: ct);
                })
