...
{
    public Task<Dictionary<string, string>> GetOrigins()
    {
        return flightService.GetFutureFlightsOriginsAsync(Context.ConnectionAborted);
    }

    public Task<Dictionary<string, string>> GetDestinations(string originId)
    {
