...
public interface ICityService
{
    ...
    Task<Dictionary<string, Dictionary<string, string>>> GetAllCitiiesPaginatedAsync(int pageIndex, int itemsPerPage, string currentSearch, CancellationToken token);
